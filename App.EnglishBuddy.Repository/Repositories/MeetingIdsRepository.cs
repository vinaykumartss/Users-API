...
public class MeetingIdsRepository : BaseRepository<MeetingIds>, IMeetingIdsRepository
{
    public EnglishBuddyDbContext _context;
    public MeetingIdsRepository(EnglishBuddyDbContext context) : base(context)
    {
        _context = context;
    }
