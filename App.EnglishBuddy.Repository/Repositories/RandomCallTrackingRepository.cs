...
public class RandomCallTrackingRepository : BaseRepository<RandomCallingTracking>, IRandomCallTrackingRepository
{
    public EnglishBuddyDbContext _context;
    public RandomCallTrackingRepository(EnglishBuddyDbContext context) : base(context)
    {
        _context = context;
    }
