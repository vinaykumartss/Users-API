...
public class RandomCallsRepository : BaseRepository<RandomCalls>, IRandomCallsRepository
{
    public EnglishBuddyDbContext _context;
    public RandomCallsRepository(EnglishBuddyDbContext context) : base(context)
    {
        _context = context;
    }
