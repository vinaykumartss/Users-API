...
public class UsersImagesRepository : BaseRepository<UsersImages>, IUsersImagesRepository
{
    public EnglishBuddyDbContext _context;
    public UsersImagesRepository(EnglishBuddyDbContext context) : base(context)
    {
        _context = context;
    }
